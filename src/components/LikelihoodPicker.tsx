...
export function LikelihoodPicker({
  ...
  return (
    <div
      ...
      className="grid grid-cols-5 gap-1 rounded-full border border-ink-border bg-ink-900/60 p-1.5"
    >
      {ORDER.map((option) => {
        ...
        return (
          <button
            ...
            className={[
              "rounded-full px-1 py-2 text-[11px] font-medium leading-tight transition",
              active
